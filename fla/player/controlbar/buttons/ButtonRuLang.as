package player.controlbar.buttons
{
	...
	public class ButtonRuLang extends Sprite
	{
		private var _interfaceObject:Object = [];
		private var _selected:Boolean = false;

		public function ButtonRuLang():void
		{
			_initInterface();
			_initListeners();
		}
		...
		{
			dispatchEvent(new LangSubsSelectEvent(LangSubsSelectEvent.LANG_SELECT, "rus", true));
		}
