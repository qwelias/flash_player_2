...
package osmf_patch
{
	 ...
	 */
	public class NetStreamDRMTrait_p extends DRMTrait
	{
		CONFIG::FLASH_10_1
		{
			/**
			 ...
			 */ 
			public function NetStreamDRMTrait_p()
			{
				this.drmServices = new DRMServices_p();	// Rustem
				super();			
			...
			private var drmServices:DRMServices_p;// = new DRMServices_p();
		}
	}
}