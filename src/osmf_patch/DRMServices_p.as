...
package osmf_patch {
	...
	public class DRMServices_p extends EventDispatcher
	{
		CONFIG::FLASH_10_1
		{
			/**
			 ...
			 *  
			 */ 
			public function DRMServices_p()
			{
				this._customToken = new flash.utils.ByteArray();
				super();
			...
			// Rustem
			public function set lToken(arg1:flash.utils.ByteArray):void
			{
				this.lastToken = arg1;
				return;
			}
			...
			{
				trace("set drm content data");	// Rustem
				lastToken = null;
			...
			{			
				...
				trace("drmManager.addEventListener");	// Rustem
			...
			{
				trace("_customToken.writeUTFBytes(" + arg1 + ")");
				this._customToken.writeUTFBytes(arg1);
			}
			// Rustem/
			...
			{				
				...
				// Rustem
				trace("drmManager.setAuthenticationToken(drmContentData.serverURL: " + this.drmContentData.serverURL + ", drmContentData.domain, " + this._customToken + ")");
				this.drmManager.setAuthenticationToken(this.drmContentData.serverURL, this.drmContentData.domain, this._customToken);
				// Rustem/
			...
			{
				// Rustem
				trace("drmManager.loadVoucher(drmContentData, LoadVoucherSetting.FORCE_REFRESH)");
				this.drmManager.setAuthenticationToken(this.drmContentData.serverURL, this.drmContentData.domain, this._customToken);
				// Rustem/
			...
			private var _customToken:flash.utils.ByteArray;	// Rustem
